...
export class EstudiantesComponent implements OnInit {
  ...
  agregarImg(x:number){
    ...
    console.log(url);
    this.estudiantes[x].image=url;
  }
  editar(x:number,elemento:string){
    ...
    switch(elemento){
      ...
      case"type":{
        ...
        let dato= prompt("ingrese el tipo");
        this.estudiantes[x].species=dato;
        break;

 }      
      case"gender":{

        let dato= prompt("ingrese el genero");
        this.estudiantes[x].gender=dato;
        break;

      }
      case"house":{

        let dato= prompt("ingrese la casa");
        this.estudiantes[x].house=dato;
        break;

      }
      case"year":{

        let dato= prompt("ingrese la fecha de nacimiento");
        this.estudiantes[x].yearOfBirth=dato;
        break;

      }
      case"patronus":{

        let dato= prompt("cual es su patronus");
        this.estudiantes[x].patronus=dato;
        break;

      }
      case"alive":{

        let dato= prompt("esta vivo");
        this.estudiantes[x].alive=dato;
        break;
